 ...
 <div class="container-fluid bg-footer bg-primary text-white mt-5">
    ...
    <div class="container-fluid bg-dark text-white py-4">
        <div class="container text-center">
            <p class="mb-0">&copy; <a class="text-secondary fw-bold" href="#">AgroVision.Com</a>. All Rights Reserved. Designed And Developed by <a class="text-secondary fw-bold" href="https://www.linkedin.com/in/dhanashree-borkar-921a78338">Dhanshree Borkar</a></p>
        </div>
    </div>
    <!-- Footer End -->
