            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item" >
                    ...
                    <div class="carousel-caption top-0 bottom-0 start-0 end-0 d-flex flex-column align-items-center justify-content-center">
                        <div class="text-start p-5" style="max-width: 900px;">
                            <h3 class="text-white">Welcome</h3>
                            <h1 class="display-1 text-white mb-md-4">Be the Part of AgroVision.</h1>
            ...
            <div class="row g-5">
                <div class="col-lg-3">
                    ...
                    <div class="text-white">
                        ...
                        <p class="mb-0">AgroVision has been honored with the prestigious Agricultural Innovation Excellence Award.</p>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row g-5">
                    ...
                    <div class="row g-0">
                        <div class="col-10">
                            <div class="position-relative">
                                <img class="img-fluid w-100" src="img/sim.jpg" alt="" style="height: 400px; " >
                                <div class="position-absolute start-0 bottom-0 w-100 py-3 px-4" style="background: rgba(52, 173, 84, .85);">
                                    <h4 class="text-white">Simran Janbandhu</h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="row g-0">
                        <div class="col-10">
                            <div class="position-relative">
                                <img class="img-fluid w-100" src="img/dhana.jpg" alt="" style="height: 400px;">
                                <div class="position-absolute start-0 bottom-0 w-100 py-3 px-4" style="background: rgba(52, 173, 84, .85);">
                                    <h4 class="text-white">Dhanashree Borkar </h4>
